...
EXTERN OrigLstar: QWORD
EXTERN TargetDR3: QWORD
EXTERN TargetSysHandler: QWORD
EXTERN SyscallBypassMagic: QWORD
...
SyscallHook proc frame
        ...
        cmp rax, 40h
        jne go_origLSTAR
        cmp qword ptr [TargetSysHandler], 0
        je go_origLSTAR
        movq rax, xmm5
        cmp rax, qword ptr [SyscallBypassMagic]
        je clear_magic
        mov rax, rcx
        mov rcx, qword ptr [TargetSysHandler]
        sysretq
clear_magic:
        xorps xmm5, xmm5
go_origLSTAR:
        movd eax, xmm4
        jmp qword ptr [OrigLstar]
SyscallHook endp
